...
#define INF_TIME_ID (0x65)
#define INF_GEN_ID (0x63)
#define INF_ODO_ID (0x60)
#define INF_TRIP_ID (0x58)
...
#define ENG_OIL_PRESSURE_INDEX get_position_datapool(ENG_OIL_PRESSURE_ID)
...
#define INF_TIME_INDEX get_position_datapool(INF_TIME_ID)
#define INF_GEN_INDEX get_position_datapool(INF_GEN_ID)
#define INF_ODO_INDEX get_position_datapool(INF_ODO_ID)
#define INF_TRIP_INDEX get_position_datapool(INF_TRIP_ID)
